...
class Form6 : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = Form6Binding.inflate(inflater, container, false)
        return binding.root
    }
